...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__helpers__["a"]; });
...
"use strict";
const makeMeASandwich = 'make sandwich: operation not permitted';
/* unused harmony export makeMeASandwich */

const sudoMakeMeASandwich =  'one open faced club sandwich coming right up';
/* harmony export (immutable) */ __webpack_exports__["a"] = sudoMakeMeASandwich;
...
const unusedHelper = __WEBPACK_IMPORTED_MODULE_0__unused_helper_2__;
...
console.log(__WEBPACK_IMPORTED_MODULE_0__re_export__["a" /* sudoMakeMeASandwich */]); // make sure this one is used.
